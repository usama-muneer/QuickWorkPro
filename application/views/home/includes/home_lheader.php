...
<head>
	...
	<title>Quick Work Pro <?php echo $title ?></title>
	<!-- BOOTSTRAP CSS -->
...
<div class="container-fluid">
	<a class="navbar-brand" href="#"><img src="<?php echo base_url(); ?>assets/img/qwplogorecwhite_edt.png"></a>
	...
	<div class="collapse navbar-collapse" id="navbarResponsive">
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item">
				<a class="btn btn-info" href="<?php echo base_url(); ?>login" >Sign In</a>
			</li>
		</ul>
	</div>
</div>
