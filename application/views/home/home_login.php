...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-body text-center">
      		<h4 class="modal-title text-center" id="exampleModalLongTitle">Login Form</h4>
        ...
        <form class="col-12" method="post" action="<?php echo base_url();?>loginc/login" id="loginForm">
          <p class="text-success"><b><?php if(isset($success)){ echo 'Password successfully updated.';} ?></b></p>
          <p><b class="text-danger"><?php if(isset($error)){ echo 'Email does not exist.';} ?></b></p>
            ...
            <!--<span class="text-danger"><?php //echo form_error("u_passwordlogin"); ?></span> -->
				...
				<div class="col-12 forgot">
					<a href="<?php echo base_url(); ?>signup">New User? Join</a>
				</div>
      </div>
    </div>
  </div>
