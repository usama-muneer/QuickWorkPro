    ...
    if(isset($service_data)){
      foreach ($service_data as $service_row) {
        ...
        <div class="col-md-3 padding card-deck">
          <div class="card">
            <a href="<?php echo base_url('homec/view_gigs/'. $service_id); ?>"><img src="<?php echo $service_picture; ?>" class="img-fluid img-viewgig" alt="Image not found" /></a>
            <div class="card-body text-center">
              <p><b><?php echo $service_name ?></b></p>
            </div>
            <div class="card-footer bg-info">
              <a href="<?php echo base_url('homec/view_gigs/'. $service_id); ?>" class="btn btn-info">View Gigs</a>
            </div>
          </div>
        </div>
        <?php
