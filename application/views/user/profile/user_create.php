...
<div class="container">
  ...
  <?php echo form_open_multipart('profilec/createuserprofile' , array('id' => 'img'));?>
    ...
    <div class="form-group">
      ...
      <textarea name="description" class="form-control" rows="4" id="desc" minlength="150" maxlength="600" required="required" placeholder="Between 150-600 characters"></textarea>
