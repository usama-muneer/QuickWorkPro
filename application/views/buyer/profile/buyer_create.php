...
<div class="container">
  ...
  <?php echo form_open_multipart('bprofilec/createuserprofile' , array('id' => 'img'));?>
    ...
    <div class="form-group">
      ...
      <textarea name="description" class="form-control" rows="4" id="desc" minlength="150" maxlength="600" placeholder="Between 150-600 characters"></textarea>
