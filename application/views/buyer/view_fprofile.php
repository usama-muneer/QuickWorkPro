			...
			<div class="col-lg-3 col-sm-12 col-12 text-center detail-part">
				<div class="row image-part m-0">
					...
					<div class="col-lg-12 col-sm-12 col-12 information-button">
						<?php echo anchor("bchatc/chat/{$user_id}", 'Contact', ['class'=>'btn btn-success']); ?>
					</div>
					<div class="col-lg-12 col-sm-12 col-12 user-name">
							       ...
							       <div class="col-lg-12 about-detail">
											<table class="table">
												<thead>
													...
													<?php
													$langsql = 'select * from languages where user_id =' . $my_id;
							        ...
							        <div class="col-lg-12 about-detail">
												<table class="table">
												  <thead>
													...
													<?php
													$skillsql = 'select * from skills where user_id =' . $my_id;
