...
<nav class="navbar navbar-expand-lg navbar-light bg-white" id="nav1">
 ...
 <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <!-- NAVBAR TOP SEARCH FORM CODE START -->
		<form class="form-inline mr-2 mr-lg-0 " method="get" action="<?php echo base_url(); ?>searchingc/showgigb">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <a class="nav-link dropdown-toggle" href="<?php echo base_url(); ?>brequestc/va_gig">Home</a>
			</li>

      <!-- NAVBAR Buying CODE START -->
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Buying
        </a>
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="<?php echo base_url(); ?>borderc/va_orders">Orders</a>
          <a class="dropdown-item" href="<?php echo base_url(); ?>brequestc/create_brequest">Post a Request</a>
          <a class="dropdown-item" href="<?php echo base_url(); ?>brequestc/view_brequest">View Requests</a>
          <a class="dropdown-item" href="<?php echo base_url(); ?>bprofilec/view_spending">View Spending</a>
        </div>
      </li>
      <!-- NAVBAR Buying CODE END -->

      <!-- NAVBAR MESSAGE CODE START -->
      <li class="nav-item dropdown">
        <a class="nav-link" href="<?php echo base_url(); ?>bprofilec/chat" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url(); ?>bprofilec/view_dashboard" data-toggle="tooltip" data-placement="bottom" title="Dashboard"><i class="fas fa-chart-bar"></i>
				</a>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
					<a class="dropdown-item" href="<?php echo base_url(); ?>bprofilec/view_profile"><?php echo $username; ?></a>
