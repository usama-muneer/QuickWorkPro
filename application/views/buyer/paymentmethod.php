...
<!-- //PAYMENT MOTHOD SELECTION CODE START -->
<div class="container" align="center">
	<div class="row">
		<div class="paymentCont">
						<div class="headingWrap">
								<h3 class="headingTop">Select Your Payment Method</h3>
								<p class="" align="">Created with bootsrap button and using radio button</p>
						</div>
                ...
                <?php echo anchor("borderc/placeorder/{$gig_id}", 'Proceed', ['class'=>'btn btn-success']); ?>
              </div>
						</div>
            <br><br><br>
					</div>
...
<!--  //PAYMENT METHOD SELECTION CODE END  -->
