...
// show message
  $(document).ready(function () {
    ...
    function showMessages(){
      $.ajax({
        type:'POST',
        url:'<?php echo base_url('bchatc/view_messages/'. $recipient_id); ?>',
        async: false,
...
<div class="container-fluid border amain-section" id="what" >
  <div class="row">
    <div class="col-md-3 col-sm-3 col-xs-12 left-sidebar">
      ...
      <div class="left-chat">
        <ul>
          <?php
            $messagesql = 'SELECT sender_id FROM messages WHERE recipient_id =' . $this->session->userdata('buyer_id') . ' GROUP BY sender_id';
          ...
          <li>
            <div class="chat-left-img">
              <a href="<?php echo base_url('bchatc/chat/'.$row['sender_id']); ?>"><img src="<?php echo base_url().$picture; ?>"></a>
            </div>
            <div class="chat-left-detail">
              <p><b><?php echo anchor("bchatc/chat/{$row['sender_id']}", $username, ['class'=>'text-success']); ?></b></p>
    ...
    <div class="col-md-9 col-sm-9 col-xs-12 right-sidebar" id="what1">
      <div class="row">
        <?php
      ...
      <form class="" action="<?php echo base_url(); ?>bchatc/sendMessage" method="post">
        <div class="row">
