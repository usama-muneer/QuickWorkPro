  ...
  <div class="row">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            ...
            <input type="text" readonly class="form-control" id="staticGig" value="<?php echo $gig_title; ?>">
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="text" name="gig_price" readonly class="form-control" id="staticAmount" value="<?php echo $gig_price; ?>">
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="text" name="gig_duration" readonly class="form-control" id="staticDuration" value="<?php echo $gig_duration; ?>">
            </div>
          </div>
