...
<div class="head-status">
  <h2 class="text-center">Your Order is <?php echo $order_status; ?> </h2>
</div>
<!-- ORDER START -->
    <div class="padding10">
    ...
    <div class="padding10">
      ...
      <hr>
        ...
        ?>
        <?php echo anchor("borderc/approveorder/{$order_id}", ' Approve Order ', ['class'=>'btn btn-success btn-lg']); ?>
        <?php echo anchor("borderc/reviseorder/{$order_id}", ' Ask for Revision ', ['class'=>'btn btn-warning btn-lg']); ?>
        <?php echo anchor("borderc/requestdispute/{$order_id}", ' Ask for Cancellation ', ['class'=>'btn btn-danger btn-lg float-right']); ?>
        <br><br>
      </div>
    </div>
    <!-- DELIVER ORDER END -->
