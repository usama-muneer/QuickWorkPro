                ...
                if(isset($order_data)){
                  ...
                  <tr>
                      ...
                      <td>
                          ...
                          <a href="#modalUpdateOrder<?php echo $order_row['order_id']; ?>" class="btn btn-info" data-toggle="modal" data-target="#modalUpdateOrder<?php echo $order_row['order_id']; ?>">Manage</a>
                      </td>
                  </tr>
                  ...
                  <div class="modal fade" id="modalUpdateOrder<?php echo $order_row['order_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <div class="modal-body">
                              <div class="container">
                                  <form method="post" action="<?php echo  base_url(); ?>Aorderc/update_order">
                                      <div class="form-group">
                                          ...
                                          <select name="order_status" class="form-control" id="exampleFormControlSelect1" required>
                                            <option value="<?php echo $order_row['order_status']; ?>"><?php echo $order_row['order_status']; ?></option>
