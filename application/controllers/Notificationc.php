                ...
                $data .= '<li class="notification-box bg-light">
                            <div class="row">
                              <div class="col-lg-3 col-sm-3 col-3 text-center">
                                <img src="'. base_url().$ppicture . '" class="w-75 rounded-circle">
                              </div>
                              <div class="col-lg-8 col-sm-8 col-8">
                                <a href="'. base_url('bchatc/chat/'. $sender_id) .'"><strong class="text-info">' .$uusername .'</strong></a>
                                <div class="notification-body"><a href="'. base_url('bchatc/chat/'. $sender_id) .'" style="color:black">' .$thismessage .'</a> </div>
              ...
              elseif($status == "unread"){
                $data .= '<li class="notification-box">
                            <div class="row">
                              ...
                              <div class="col-lg-8 col-sm-8 col-8">
                                <a href="'. base_url('bchatc/chat/'. $sender_id) .'"><strong class="text-info">' .$uusername .'</strong></a>
                                <div class="notification-body"><a href="'. base_url('bchatc/chat/'. $sender_id) .'" style="color:black"><b>You have ' .$tmessage .' unread Messages. Click here to view...</b></a> </div>
                                <small class="text-warning">'. $ldate .'</small>
                              </div>
                            </div>
                          </li>';
